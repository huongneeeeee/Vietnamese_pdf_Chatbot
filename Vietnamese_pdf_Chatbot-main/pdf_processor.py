...
# --- THAY ĐỔI: Import thêm các Loader mới ---
...
class PDFDatabaseManager:
    ...
    # --- THAY ĐỔI QUAN TRỌNG: Hàm chọn Loader dựa trên đuôi file ---
    def get_file_loader(self, file_path):
        ...
        if ext == '.pdf':
            ...
            # encoding='utf-8' rất quan trọng với file tiếng Việt
